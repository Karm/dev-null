...
public class ImageResource {
    ...
    /**
     * Resizes a given image to the biggest of given height, width values, keeping aspect ratio.
     *
    ...
    private BufferedImage watermarkImage(InputStream in) throws IOException {
        ...
        img.getGraphics()
                .drawImage(watermark, img.getWidth() - watermark.getWidth(), img.getHeight() - watermark.getHeight(), null);
