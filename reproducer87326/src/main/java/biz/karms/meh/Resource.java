...
public class Resource {
    ...
    public String testSecureCall() {
        ...
        try (final Client c = ClientBuilder.newClient();
                final Response response = c.target("http://localhost:" + port + "/protected")
    ...
    private static String generateJWT(String key) {
        ...
        return provider.generateToken(new io.vertx.core.json.JsonObject().mergeIn(jsonObject), new JWTOptions().setAlgorithm("RS256"));
    }
}
